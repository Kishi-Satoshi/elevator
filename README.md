...
- **フロア回遊**: ドアが開いたら「フロアに出る」で売場を歩き回れる。しばらくするとエレベーターは他階へ出発し、**乗場の呼びボタン（3D）**で呼び戻せる
- **百貨店フロア演出**: 到着階ごとに乗場の内装色・照明・売場サイネージ・什器と商品（化粧品カウンター / 衣料ラック+マネキン / 書棚 / レストラン席 / 催事ステージ / ラウンジ / 屋上庭園）が変わる
